package com.learn.nitin.utilities;
...
public class OldDateUtilities implements Serializable {
    ...
    public static Timestamp getFirstDayOfYear(Timestamp tsTimestamp1) {
        int strDay = 01;
        int strMonth = 0;
    ...
    public static Timestamp resetDate(Timestamp tsTimestamp1) {
        int strDate = 01;
        GregorianCalendar gregorianCalendar = new GregorianCalendar();
        gregorianCalendar.setTime(tsTimestamp1);
    ...
    public static int getMonthsBetween(
        ...
        HashMap hmSetDates = setDates(tsTimestamp1, tsTimestamp2);
    ...
    public static Timestamp getTimestamp(Date dDate1) {
    ...
    public static int getYearsBetween(
            Timestamp tsYearsBetween1,
            Timestamp tsYearsBetween2) {
        Calendar calendarInstance1 = Calendar.getInstance();
        Calendar calendarInstance2 = Calendar.getInstance();

        int iYearsBetweenDates = 0;
        HashMap hmSetDates = setDates(tsYearsBetween1, tsYearsBetween2);
    ...
    public static Timestamp getTimestamp(String sMonth, String sYear) {
        int imonth = 0;
        int iday = 1;
    ...
    public static Timestamp getMinTimestamp(ArrayList alTimestamp) {
        Timestamp tsMinTimestamp = null;
        Timestamp tsFirstTimestamp = null;
        Timestamp tsNextTimestamp = null;
    ...
    public static Timestamp getMaxTimestamp(ArrayList alTimestamp) {
        Timestamp tsMaxTimestamp = null;
        Timestamp tsFirstTimestamp = null;
        Timestamp tsNextTimestamp = null;
        int iTimestampSize = alTimestamp.size();
        for (int i = 0; i < iTimestampSize; i++) {
